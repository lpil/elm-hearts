...
var _user$project$Heart$toForm = function (_p0) {
	var _p1 = _p0;
	var _p2 = _p1._0.color;
	var size = _p1._0.width * 0.585;
	var bump = A2(
		_evancz$elm_graphics$Collage$filled,
		_p2,
		_evancz$elm_graphics$Collage$circle(size / 2));
	var leftBump = A2(_evancz$elm_graphics$Collage$moveX, 0 - (size / 2), bump);
	var rightBump = A2(_evancz$elm_graphics$Collage$moveY, size / 2, bump);
	var body = A2(
		_evancz$elm_graphics$Collage$filled,
		_p2,
		A2(_evancz$elm_graphics$Collage$rect, size, size));
	return A2(
...
var _user$project$Heart$Heart = function (a) {
	return {ctor: 'Heart', _0: a};
};
var _user$project$Heart$fromObject = function (obj) {
	return _user$project$Heart$Heart(obj);
};
var _user$project$Heart$new = function (c) {
	return _user$project$Heart$Heart(
		{width: 1, color: c});
};
var _user$project$Heart$grow = function (_p3) {
	var _p4 = _p3;
	var _p5 = _p4._0;
	return _user$project$Heart$Heart(
		_elm_lang$core$Native_Utils.update(
			_p5,
			{width: 1 + (_p5.width * 1.02)}));
};
var _user$project$Heart$limitedGrow = F2(
	function (limit, heart) {
		var grown = _user$project$Heart$grow(heart);
		var _p6 = grown;
		var h = _p6._0;
		return (_elm_lang$core$Native_Utils.cmp(h.width, limit) > 0) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(grown);
	});

var _user$project$Theme$lightRainbow = {
	ctor: '::',
	_0: A3(_elm_lang$core$Color$rgb, 255, 243, 170),
	_1: {
		ctor: '::',
		_0: A3(_elm_lang$core$Color$rgb, 255, 208, 168),
		_1: {
			ctor: '::',
			_0: A3(_elm_lang$core$Color$rgb, 255, 177, 177),
			_1: {
				ctor: '::',
				_0: A3(_elm_lang$core$Color$rgb, 217, 209, 255),
				_1: {
					ctor: '::',
					_0: A3(_elm_lang$core$Color$rgb, 183, 239, 255),
					_1: {ctor: '[]'}
				}
			}
		}
...
var _user$project$Theme$pastelPurpleDawn = {
	ctor: '::',
	_0: A3(_elm_lang$core$Color$rgb, 252, 196, 255),
	_1: {
		ctor: '::',
		_0: A3(_elm_lang$core$Color$rgb, 239, 181, 255),
		_1: {
			ctor: '::',
			_0: A3(_elm_lang$core$Color$rgb, 227, 177, 255),
			_1: {
				ctor: '::',
				_0: A3(_elm_lang$core$Color$rgb, 217, 164, 255),
				_1: {
					ctor: '::',
					_0: A3(_elm_lang$core$Color$rgb, 210, 145, 255),
					_1: {
						ctor: '::',
						_0: A3(_elm_lang$core$Color$rgb, 217, 164, 255),
						_1: {
...
var _user$project$Theme$pastelRainbowPeach = {
	ctor: '::',
	_0: A3(_elm_lang$core$Color$rgb, 255, 211, 182),
	_1: {
		ctor: '::',
		_0: A3(_elm_lang$core$Color$rgb, 255, 170, 165),
		_1: {
			ctor: '::',
			_0: A3(_elm_lang$core$Color$rgb, 255, 139, 148),
			_1: {ctor: '[]'}
		}
	}
};
var _user$project$Theme$pastelRainbow = {
	ctor: '::',
	_0: A3(_elm_lang$core$Color$rgb, 168, 230, 207),
	_1: {
		ctor: '::',
		_0: A3(_elm_lang$core$Color$rgb, 220, 237, 193),
		_1: {
			ctor: '::',
			_0: A3(_elm_lang$core$Color$rgb, 255, 211, 182),
			_1: {
...
var _user$project$Theme$allThemes = {
	ctor: '::',
	_0: _user$project$Theme$pastelRainbow,
	_1: {
		ctor: '::',
		_0: _user$project$Theme$pastelRainbowPeach,
		_1: {
			ctor: '::',
			_0: _user$project$Theme$pastelPurpleDawn,
			_1: {
				ctor: '::',
				_0: _user$project$Theme$lightRainbow,
				_1: {ctor: '[]'}
			}
		}
	}
};
var _user$project$Theme$random = A2(
	_elm_lang$core$Random$map,
	function (i) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			...
			_elm_lang$core$List$head(
				A2(_elm_lang$core$List$drop, i, _user$project$Theme$allThemes)));
	},
	A2(
		_elm_lang$core$Random$int,
		0,
		_elm_lang$core$List$length(_user$project$Theme$allThemes) - 1));

var _user$project$Heart_Stream$new = function (colors) {
	return A2(
		_elm_community$lazy_list$Lazy_List$map,
		_user$project$Heart$new,
		_elm_community$lazy_list$Lazy_List$cycle(
			_elm_community$lazy_list$Lazy_List$fromList(colors)));
};
var _user$project$Heart_Stream$safeNext = function (stream) {
	safeNext:
	while (true) {
		var _p0 = _elm_community$lazy_list$Lazy_List$headAndTail(stream);
		if (_p0.ctor === 'Just') {
			return _p0._0;
		} else {
			var _v1 = _user$project$Heart_Stream$new(_user$project$Theme$pastelPurpleDawn);
			stream = _v1;
			continue safeNext;
		}
	}
...
var _user$project$Types$Model = F5(
	function (a, b, c, d, e) {
		return {windowWidth: a, windowHeight: b, windowHyp: c, hearts: d, heartStream: e};
	});
var _user$project$Types$NewHeartTick = function (a) {
	return {ctor: 'NewHeartTick', _0: a};
};
var _user$project$Types$AnimationTick = function (a) {
	return {ctor: 'AnimationTick', _0: a};
};
var _user$project$Types$NewThemeTick = function (a) {
	return {ctor: 'NewThemeTick', _0: a};
};
var _user$project$Types$NewTheme = function (a) {
	return {ctor: 'NewTheme', _0: a};
};
...
var _user$project$View$root = function (model) {
	return _evancz$elm_graphics$Element$toHtml(
		A3(
			...
			A2(
				_elm_lang$core$List$map,
				_user$project$Heart$toForm,
				_elm_lang$core$List$reverse(model.hearts))));
};

var _user$project$Update$windowSize = F2(
	function (_p0, model) {
		var _p1 = _p0;
		var _p3 = _p1.width;
		var _p2 = _p1.height;
		var hypotenuse = _elm_lang$core$Basics$sqrt(
			_elm_lang$core$Basics$toFloat(
				Math.pow(_p3, 2) + Math.pow(_p2, 2)));
		return _elm_lang$core$Native_Utils.update(
			model,
			{windowWidth: _p3, windowHeight: _p2, windowHyp: hypotenuse});
	});
var _user$project$Update$newHeartTick = function (model) {
	var _p4 = _user$project$Heart_Stream$safeNext(model.heartStream);
	var heart = _p4._0;
	var stream = _p4._1;
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			hearts: {ctor: '::', _0: heart, _1: model.hearts},
			heartStream: stream
		});
};
var _user$project$Update$animationFrame = F2(
	function (time, model) {
		var limit = model.windowHyp * 3;
		var hearts = A2(
			_elm_lang$core$List$filterMap,
			_user$project$Heart$limitedGrow(limit),
			model.hearts);
		return _elm_lang$core$Native_Utils.update(
			model,
			{hearts: hearts});
	});
var _user$project$Update$newTheme = F2(
	function (theme, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				heartStream: _user$project$Heart_Stream$new(theme)
			});
	});
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _elm_lang$animation_frame$AnimationFrame$times(_user$project$Types$AnimationTick),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second / 3, _user$project$Types$NewHeartTick),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second * 7, _user$project$Types$NewThemeTick),
					_1: {
						ctor: '::',
...
var _user$project$Main$getWindowSizeCmd = A2(_elm_lang$core$Task$perform, _user$project$Types$WindowSize, _elm_lang$window$Window$size);
var _user$project$Main$newThemeCmd = A2(_elm_lang$core$Random$generate, _user$project$Types$NewTheme, _user$project$Theme$random);
	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'WindowSize':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					A2(_user$project$Update$windowSize, _p0._0, model),
					{ctor: '[]'});
			case 'NewHeartTick':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_user$project$Update$newHeartTick(model),
					{ctor: '[]'});
			case 'AnimationTick':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					A2(_user$project$Update$animationFrame, _p0._0, model),
					{ctor: '[]'});
			case 'NewTheme':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					A2(_user$project$Update$newTheme, _p0._0, model),
					{ctor: '[]'});
			default:
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					...
					{
						ctor: '::',
						_0: _user$project$Main$newThemeCmd,
						_1: {ctor: '[]'}
					});
		}
	});
var _user$project$Main$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	{
		...
		windowHeight: 0,
		windowHyp: 0,
		heartStream: _user$project$Heart_Stream$new(_user$project$Theme$pastelPurpleDawn),
		hearts: {ctor: '[]'}
	},
	{
		ctor: '::',
		...
		_1: {
			ctor: '::',
			_0: _user$project$Main$getWindowSizeCmd,
			_1: {ctor: '[]'}
		}
	});
